...
import headerVideo from './assets/Customer Header.mp4'
...
const PORTFOLIO_SLUG = 'customer'
const PORTFOLIO_NAME = 'Customer'
const SHOWCASE = PORTFOLIO_SHOWCASE[PORTFOLIO_SLUG]
const NICHE_SKILLS = ['Power Builder']
const MAIN_CHALLENGES = ['Difficulties in finding resources with Power Builder skills.']
const MITIGATIONS = ['Pursuing options to broaden ability to deliver and support from different Geos.']
