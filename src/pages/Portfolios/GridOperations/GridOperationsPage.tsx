...
import headerVideo from './assets/GridOperations Header.mp4'
...
const PORTFOLIO_SLUG = 'grid-operations'
const PORTFOLIO_NAME = 'Grid Operations'
const SHOWCASE = PORTFOLIO_SHOWCASE[PORTFOLIO_SLUG]

const NICHE_SKILLS = ['ArcGIS', 'Powerclerk']
const CHALLENGES = ['Team is currently facing challenges when talking about finding ArcGIS and Powerclerk resources.']
const MITIGATIONS = [
